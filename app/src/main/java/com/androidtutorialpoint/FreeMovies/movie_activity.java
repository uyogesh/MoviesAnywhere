...
public class movie_activity extends AppCompatActivity {
   ...
   RelativeLayout relativeLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.androidtutorialpoint.volleytutorial.R.layout.activity_movie_activity);
        lst = (ListView) findViewById(com.androidtutorialpoint.volleytutorial.R.id.List_episode);
        tx = (TextView) findViewById(com.androidtutorialpoint.volleytutorial.R.id.we_view);
        relativeLayout=(RelativeLayout)findViewById(com.androidtutorialpoint.volleytutorial.R.id.loadingPanel1);
